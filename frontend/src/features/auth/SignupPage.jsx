...
export const SignupPage = () => {
  const { register, navigateTo, user } = useApp();
      ...
      <div className={styles.formWrap}>
        <div className={styles.cardHead}>
          <h2 className={styles.title}>
            Create your <span className={styles.titleBrand}>account</span>
          </h2>
          <p className={styles.subtitle}>
            Connect with creators, unlock exclusive content and start your Fantrio journey.
          </p>
        </div>
        ...
        <form className={styles.form} onSubmit={handleSubmit} noValidate>
          ...
          <div className={styles.field}>
            <label className={styles.label} htmlFor="signup-referral">
          ...
          <label className={styles.termsRow}>
            ...
            <span className={styles.termsText}>
              I agree to the{' '}
              <span className={styles.termsLink} onClick={() => navigateTo('/terms')}>
                Terms of Service
              </span>{' '}
              and{' '}
              <span className={styles.termsLink} onClick={() => navigateTo('/privacy')}>
                Privacy Policy
              </span>
            </span>
          </label>
